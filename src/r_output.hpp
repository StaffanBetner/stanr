...
// ===================================================================
// Logger — forwards Stan log messages to R console
// ===================================================================
...
class r_logger : public stan::callbacks::logger {
 ...
 public:
  explicit r_logger(bool verbose) : verbose_(verbose) {}
  ...
  void warn(const std::string& msg) override { REprintf("[WARN] %s\n", msg.c_str()); }

  void error(const std::string& msg) override { REprintf("[ERROR] %s\n", msg.c_str()); }

  void fatal(const std::string& msg) override { REprintf("[FATAL] %s\n", msg.c_str()); }
};
